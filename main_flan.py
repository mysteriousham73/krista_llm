...
#"query": "query_type should be one of: satellite_pass_prediction, satellite_status. satellite_pass_prediction is when the satellite will be overhead. satellite_status is about the satellite state including possible parameters range, latitude, longitude, position, altitude, frequencies. turn the question <what is the altitude of the iss> into JSON containing only satellite_name, request_parameters, and query_type. JSON satellite_name, query_type, request_parameters:{\"satellite_name\":"
